...
public class DashboardIntegrationTest {
	...
	void testDashboardDataMapping() {
		...
		when(dashboardService.toRoadDataDTOs(List.of(road))).thenReturn(List.of(roadDTO));
		when(dashboardService.toPotholeResponses(List.of(pothole))).thenReturn(List.of(potholeDTO));

		// Assertions
		List<RoadDataDTO> roads = dashboardService.toRoadDataDTOs(List.of(road));
		List<PotholeResponse> potholes = dashboardService.toPotholeResponses(List.of(pothole));
